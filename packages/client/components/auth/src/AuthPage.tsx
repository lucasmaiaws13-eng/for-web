...
const Root = styled("div", {
  base: {
    ...
    background: `
      radial-gradient(900px 520px at 12% -8%, rgba(249, 115, 22, 0.32), transparent 62%),
      radial-gradient(760px 460px at 88% 4%, rgba(255, 171, 66, 0.24), transparent 58%),
      radial-gradient(820px 620px at 60% 108%, rgba(217, 69, 43, 0.26), transparent 60%),
        ...
        <Nav>
          <NavItems variant="stack">
            <span style={{ opacity: "0.35", "font-size": "0.85em" }}>
              Callju &middot; nosso canto na internet
            </span>
          </NavItems>
        </Nav>
      </Base>
